                ...
                <div className='row row-gap-5'>
                    <div className='type-writer-container col-12 col-lg-7'>
                        ...
                        <p className='my-type-writer'>
                            ...
                            <Typewritter  texts={[" FrontEnd Developer", "  React JS Developer", " Web Developer"]}
                            speed ={200}
                            deleteSpeed={100}
                            delay={1000}/>
                        </p>
                        <p className='sup-paragraph'>
                            Hello Everyone I have 9 months Of Experience In web Development
                        </p>
                        <a className='main-connect' href="#connect" rel="noopener noreferrer"><span>
                            Let's connect</span>
